...
import 'package:sains/animationsplash/fadeanimation.dart';
      ...
      ..addStatusListener((status) {
        if (status == AnimationStatus.completed) {
          Navigator.pushReplacement(context,
              PageTransition(type: PageTransitionType.fade, child: FitnessAppHomeScreen()));
        }
      });
  }
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  FadeAnimation(
                      1.3,
                      Text(
                        "Adik-adik dah bersedia nak belajar mengenai Sains?",
                        style: TextStyle(
