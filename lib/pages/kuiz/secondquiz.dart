...
class DesignCourseHomeScreen1 extends StatefulWidget {
  @override
  _DesignCourseHomeScreen1State createState() =>
      _DesignCourseHomeScreen1State();
}
...
class _DesignCourseHomeScreen1State extends State<DesignCourseHomeScreen1>
  ...
  Future<void> _showQuizDialog2() async {
    switch (await showDialog<int>(
      ...
      case 2:
        Navigator.of(context).push(
            MaterialPageRoute(builder: (BuildContext context) => Susah2()));
    }
  }
  ...
  Future<void> _showQuizDialog3() async {
    switch (await showDialog<int>(
      ...
      case 2:
        Navigator.of(context).push(
            MaterialPageRoute(builder: (BuildContext context) => Susah3()));
    }
  }
  ...
  Future<void> _showQuizDialog4() async {
    switch (await showDialog<int>(
      ...
      case 2:
        Navigator.of(context).push(
            MaterialPageRoute(builder: (BuildContext context) => Susah4()));
    }
  }
  ...
  Future<void> _showQuizDialog5() async {
    switch (await showDialog<int>(
      ...
      case 2:
        Navigator.of(context).push(
            MaterialPageRoute(builder: (BuildContext context) => Susah5()));
    }
  }
  ...
  Future<void> _showQuizDialog6() async {
    switch (await showDialog<int>(
      ...
      case 2:
        Navigator.of(context).push(
            MaterialPageRoute(builder: (BuildContext context) => Susah6()));
    }
  }
  ...
  Future<void> _showQuizDialog7() async {
    switch (await showDialog<int>(
      ...
      case 2:
        Navigator.of(context).push(
            MaterialPageRoute(builder: (BuildContext context) => Susah7()));
    }
  }
  ...
  Future<void> _showQuizDialog8() async {
    switch (await showDialog<int>(
      ...
      case 2:
        Navigator.of(context).push(
            MaterialPageRoute(builder: (BuildContext context) => Susah8()));
    }
  }
  ...
  Future<void> _showQuizDialog9() async {
    switch (await showDialog<int>(
      ...
      case 2:
        Navigator.of(context).push(
            MaterialPageRoute(builder: (BuildContext context) => Susah9()));
    }
  }
  ...
  Future<void> _showQuizDialog10() async {
    switch (await showDialog<int>(
      ...
      case 2:
        Navigator.of(context).push(
            MaterialPageRoute(builder: (BuildContext context) => Susah10()));
    }
  }
}
